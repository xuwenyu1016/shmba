<?php exit;?>00157508738434edef99f2fd6e16f9e6cfdae3b8ed77s:89946:"a:2:{s:8:"template";s:89881:"﻿<?php $__Template->display("themes/default/head"); ?>
...
<section class="condition-basics am-padding-vertical-xl">
    <div class="am-container">
        ...
        <h4 class="am-margin-top-lg"><span class="am-center">高校MBA报考条件</span><span></span></h4>
        ...
        <ul class="am-avg-sm-3 am-margin-top-xl">
            <li>
                <article>
                    ...
                    <p class="am-margin-top-0 am-margin-bottom-sm am-text-center am-text-sm">出色的MBA申请材料，是冲击高校的第一关。2018年MBA第一批申请材料审核通过率，清华为7.46%、北大为5%、上海交大10%以下。申请材料避免沦为炮灰之3大要素：较成功的职业生涯；有明晰的短、中、长期职业生涯规划；有明确的MBA学习目标。</p>
                </article>
            </li>
            <li>
                <article>
                    ...
                    <p class="am-margin-top-0 am-margin-bottom-sm am-text-center am-text-sm">清华、北大、上海交大等MBA高校仅开设提前面试，笔试后再面试的录取方式已被废弃。即使申请材料通过审核，在提前面试阶段，通过率也仅在10%~30%。提前面试如何脱颖而出，乃是冲击高校的重中之重。</p>
                </article>
            </li>
            <li>
                <article>
                    ...
                    <p class="am-margin-top-0 am-margin-bottom-sm am-text-center am-text-sm">MBA一直被称为"史上最贵的专业"，高校MBA的学费均在30万元以上。报考高校MBA，需要坚实的经济实力做后盾。但高校带来的薪资提升、广阔的人生平台、强大的人脉资源也是普通院校所望尘莫及的。 </p>
                </article>
            </li>
        </ul>
    </div>
                        ...
                        <li>
                            <article class="condition-questions-box am-padding-sm">
                                ...
                                <div class="condition-questions-accordion">
                                    ...
                                    <dt class="am-accordion-title">
                                        <p class="am-margin-top-0 am-margin-bottom-xs">我能被高校录取的几率有多高？</p>
                                        <p class="am-margin-vertical-xs am-text-xs am-text-truncate">如果准备充分，能够在提前批面试展现清晰的职业规划和领导潜能，同时笔试达到最低分数线，就能成功被高校录取。</p>
...
<section class="condition-besties am-padding-vertical-xl">
    <div class="am-container">
        ...
        <p class="am-text-center am-margin-vertical-xs">MBA院校录取以个人背景和笔试及格线为底线，但否能被高校青睐看的是个人综合能力的表现。</p>
    ...
    <div class="am-container">
        ...
        <article class="am-margin-top-lg am-padding-xl">
            <div class="condition-teacher-intro am-padding-lg">
                ...
                <p class="am-margin-vertical-sm">华章MBA教育集团创始人、上海华章校长、MBA提前面试导师、18年MBA指导经验，至今已成功帮助数万学子进入高校。</p>
                <p class="am-margin-vertical-sm">校长寄语：没有谁比我们更有把握让您获得硕士学历、学位，我们的升学率永远名列前茅！</p>

                <button class="checkMore am-margin-top-lg" id="mianfeizixun">免费获取1vs1咨询</button>
            </div>
...
";s:12:"compile_time";i:1543551384;}";
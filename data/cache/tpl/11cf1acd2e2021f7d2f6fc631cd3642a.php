<?php exit;?>001575088213210612770506b0f4f415e8445c8dd282s:17582:"a:2:{s:8:"template";s:17517:"
...
<script>
    window.location.href="/topic-MBATiQianMianShi.html";
</script>
...
<div class="partTwo">
    <ul class="am-avg-sm-2 am-padding-sm">
        <li>
            <h2 class="am-text-center">上海华章</h2>
...
<div class="partThree am-padding-horizontal-sm am-padding-top-sm">
    ...
    <h4 class="am-margin-top-sm am-padding-horizontal-lg am-text-justify">报考MBA的同学,大多对”提前面试”一词几乎是耳熟能详，但对其中的“潜规则”却只是略知一二，更别提对在提前面试中拿到优秀资格还有几分胜筹了。这里，华章就为您层层揭开“MBA提前面试”的神秘面纱。</h4>
        ...
        <li>
            <div class="container ">
                <a href="/">
                    ...
                    <h3 class="am-text-truncate">黄浦MBA面试班开班
                    </h3>
                    <h4 class="am-text-truncate">面试技巧讲解</h4>
                    <h5>主讲人：高校MBA面试官<br/>
                        时间：7月5日 周四<br/>18:30-21:00<br/>
                        地址：黄浦区九江路675-685号长江新能源大厦
                    </h5>
                </a>
            </div>
        ...
        <li>
            <div class="container  ">
                <a href="/">
                    ...
                    <h3 class="am-text-truncate">徐汇MBA面试开班</h3>
                    <h4 class="am-text-truncate">组面技巧讲解</h4>
                    <h5>主讲人：高校MBA面试官<br/>
                        时间：7月7日  周六 <br/>17:30-20:30<br/>
                        地址：徐汇区番禺路898号3楼大教室
                    </h5>
                </a>
            </div>
...
<div class="partSix am-padding-horizontal-sm">
    ...
    <ul class="am-avg-sm-2">
        ...
        <li class="am-padding-sm sixty">
            <p class="am-text-xs am-margin-vertical-0">名校MBA面试政策解析</p>
...
<div class="partSeven am-padding-vertical-sm">
    ...
    <h2 class="am-text-center">盛邀交大、财大、复旦面试官</h2>
                ...
                <ul class="am-avg-sm-2">
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">樊登读书会创始人；华章教育集团董事长、MBA讲师</p>
                        </article>
                    </li>
                    <li>
                        <article class="am-padding-sm">

                            <img src="/upload/2017-12-04/51.png" class="am-img-responsive am-center" alt="赵海峰 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>赵海峰 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">同济大学MBA面试官、同济大学博士生导师、同济大学经济与管理学院教授。</p>
                ...
                <ul class="am-avg-sm-2">
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/52.png" class="am-img-responsive am-center" alt="秦铭 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>秦铭 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">上海财大MBA面试官、上市公司人力资源总监。</p>
                    ...
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/51.png" class="am-img-responsive am-center" alt="张文浩 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>张文浩 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">上海交大高金MBA面试官，面试导师。</p>
                ...
                <ul class="am-avg-sm-2">
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/52.png" class="am-img-responsive am-center" alt="刘江 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>刘江 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">上海财大MBA面试官、上海财大MBA职业导师，上市公司战略总监。</p>
                    ...
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/51.png" class="am-img-responsive am-center" alt="吕炜 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>吕炜 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">复旦大学MBA面试官，华东师范大学MBA面试官、职业导师。</p>
                ...
                <ul class="am-avg-sm-2">
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/52.png" class="am-img-responsive am-center" alt="张明 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>张明 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">复旦大学MBA面试官、统计大学MBA面试官、上海交大MBA面试官、MBA职业导师。</p>
                    ...
                    <li>
                        <article class="am-padding-sm">
                            ...
                            <img src="/upload/2017-12-04/51.png" class="am-img-responsive am-center" alt="文超 面试导师" draggable="false">
                            <p class="am-text-center am-margin-bottom-0"><b>文超 面试导师</b></p>
                            <p class="am-text-center am-margin-vertical-0 am-text-xs">上海交大MBA面试官、上海财大MBA面试官、上市公司总经理。</p>
...
<div class="interview-student am-padding-sm">
    ...
    <h2 class="am-text-center">华章提前面试录取学员</h2>
...
";s:12:"compile_time";i:1543552213;}";
<?php exit;?>001575095649675ce96d9458f606eae7df235e9a777fs:7043:"a:2:{s:8:"template";s:6979:"
...
<div class="layerBox am-padding-horizontal-sm am-padding-bottom-sm">
    ...
    <?php if ( $list['MPA'] ==  $categoryInfo['name']  && date('Y-m-d',$list['time']) >=  date("Y-m-d") ){ ?>
    <article class="layer">
        <a href="<?php echo $list["aurl"];?>">
            <div class="calender">
...
<?php $__Template->display("themes/mobile/ending"); ?>";s:12:"compile_time";i:1543559649;}";
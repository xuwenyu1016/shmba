<?php exit;?>0015639829589f1954030988b42c991b0b6b50ac6252s:1826:"a:2:{s:8:"template";s:1762:"<?php $__Template->display("themes/default/head"); ?>
    ...
    <div class="am-container">
        ...
        <div class="gallery-box am-margin-top-lg">
            <ul class="am-avg-sm-3 gallery-content am-padding-right-sm">
                <?php $listList = service("duxcms","Label","contentList",array( "app"=>"DuxCms", "label"=>"contentList", "class_id"=>14 , "limit"=>102));  if(is_array($listList)) foreach($listList as $list){ ?>
                <li>
...
";s:12:"compile_time";i:1532446958;}";
<?php exit;?>001575080930d6413ba5707125d0b3f6c9d5f83462a9s:1822:"a:2:{s:8:"template";s:1758:"<?php $__Template->display("themes/default/head"); ?>
    ...
    <div class="am-container">
        ...
        <div class="gallery-box am-margin-top-lg">
            <ul class="am-avg-sm-3 gallery-content am-padding-right-sm">
                <?php $listList = service("duxcms","Label","contentList",array( "app"=>"DuxCms", "label"=>"contentList", "class_id"=>36 , "limit"=>102));  if(is_array($listList)) foreach($listList as $list){ ?>
                <li>
...
";s:12:"compile_time";i:1543544930;}";
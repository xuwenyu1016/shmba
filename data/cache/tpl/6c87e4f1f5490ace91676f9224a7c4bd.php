<?php exit;?>001575344884743bd05dbfd533e8d1d1a58e63f0e3c3s:13277:"a:2:{s:8:"template";s:13212:"﻿
...
<section class="consult-highlights am-padding-horizontal-sm am-padding-bottom-xs">
    ...
    <form action="<?php echo U('DuxCms/Form/push');?>" method="post" class="formConsult formSubmit">
...
<section class="consult-gift am-padding-horizontal-sm">
    ...
    <p class="am-margin-vertical-xs">《数学公式手册》、《数学分册》、《MBA联考历年真题册》、《各大院校简章》、华章精美笔记本</p>
        ...
        <li>
            <div class="container height-auto">
                <a href="/">
                    ...
                    <h4 class="am-text-truncate am-text-center am-margin-vertical-xs">交大安泰专场</h4>
                    <p class="am-text-truncate">交大安泰MBA招生政策</p>
                    <p>主讲人：安泰MBA招生老师<br/>
                        时间：12月15日 周六  <br/>15:50-16:00<br/>
                        地址：徐汇区漕宝路66号光大会展中心国际大酒店二楼9号厅
                    </p>
                </a>
            </div>
            <button class="signUp am-margin-vertical-sm" id="zixunhui3" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0, width: 300, height: 270}">立即预约</button>
        </li>
        <li>
            <div class="container height-auto ">
                <a href="/">
                    <img src="/upload/2017-12-06/80.jpg" class="am-img-responsive am-center"  alt="上海华章MBA-提前面试"/>
                    <h4 class="am-text-truncate am-text-center am-margin-vertical-xs">财大专场</h4>
                    <p class="am-text-truncate">财大MBA招生政策</p>
                    <p>主讲人：财大MBA招生老师<br/>
                        时间：12月15日 周六   <br/>14:00-14:30<br/>
                        地址：徐汇区漕宝路66号光大会展中心国际大酒店二楼9号厅
                    </p>
                </a>
            </div>
            <button class="signUp am-margin-vertical-sm" id="zixunhui2" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0, width: 300, height: 270}">立即预约</button>
           <!-- <button class="am-text-truncate signUp" id="zixunhui4">已结束</button>-->
        </li>
...
<section class="consult-location am-padding-horizontal-sm am-padding-bottom-sm">
    ...
    <p class="am-margin-vertical-xs">时间：<?php echo $categoryInfo["consultDate"];?></p>

    <p class="am-margin-vertical-xs">地址：<?php echo $categoryInfo["consultLocation"];?></p>

    <p class="am-margin-vertical-xs">活动人数：120人</p>

    <p class="am-margin-vertical-xs">天气：多云转晴</p>

    <div style="width:100%;height:200px;border:#ccc solid 1px;font-size:12px" id="<?php echo $categoryInfo["baiduditu"];?>"></div>
</section>

<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">立即获取
            <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
        </div>
        <div class="am-modal-bd">
            <form action="<?php echo U('DuxCms/Form/push');?>" method="post" class="formSubmit am-margin-bottom-lg" id="acquireFormData_bottom">
...
";s:12:"compile_time";i:1543808884;}";
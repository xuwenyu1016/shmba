<?php exit;?>001575082863d7426c54fa6dbaf94e7d6e1e8b25512as:7200:"a:2:{s:8:"template";s:7136:"
...
<section class="schoolList am-padding-horizontal-sm">
    <ul class="am-avg-sm-3">
        <?php $listList = service("article","Label","contentList",array( "app"=>"Article", "label"=>"contentList", "class_id"=>1, "order"=>"time desc" , "limit"=>6));  if(is_array($listList)) foreach($listList as $list){ ?>
        <li>
            <div class="innerBox">
...
<?php $__Template->display("themes/mobile/ending"); ?>";s:12:"compile_time";i:1543546863;}";
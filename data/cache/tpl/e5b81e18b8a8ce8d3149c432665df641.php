<?php exit;?>0015750946297d726aa8830c0c8eeb19c73aa4277a08s:4148:"a:2:{s:8:"template";s:4084:"﻿<?php $__Template->display("themes/default/head"); ?>
    ...
    <div class="am-container">
        ...
        <div class="gallery-box am-margin-top-lg">
            <article class="gallery-content am-padding-right-sm">
                ...
                <a href="/topic-MBAXinBanKaiBan.html">
                ...
                <ul class="am-avg-sm-3 am-margin-top-lg">
                    <?php $listList = service("duxcms","Label","contentList",array( "app"=>"DuxCms", "label"=>"contentList", "class_id"=>71 , "limit"=>102));  if(is_array($listList)) foreach($listList as $list){ ?>
                    <li>
...
";s:12:"compile_time";i:1543558629;}";
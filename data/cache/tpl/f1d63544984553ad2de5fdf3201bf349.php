<?php exit;?>001551854842455e6efb1635b1bd796860cea2fbf30es:26802:"a:2:{s:8:"template";s:26737:"<?php $__Template->display("themes/default/head"); ?>
...
<section class="schoolInfoDownload am-padding-vertical-xl">
    <div class="am-container">
        <h2 class="title">
            <span class="num">01</span>
            <span class="numContent"><b class="en">MBA</b>联考<b class="red">面试经验下载</b></span>
        </h2>
        <ul class="am-avg-sm-5 am-padding-top-sm">
            ...
            <li>
                <div data-am-modal="{target: '#doc-modal-<?php echo $list["i"];?>', closeViaDimmer: 0, width: 400, height: 240}">
...
<section class="letter-download am-padding-vertical-xl">
    <div class="am-container">
        <h2 class="title">
        ...
        <ul class="am-avg-sm-5 am-padding-top-sm">
            <?php $listList = service("article","Label","contentList",array( "app"=>"Article", "label"=>"contentList", "class_id"=>1, "expand_id"=>6 , "limit"=>13));  if(is_array($listList)) foreach($listList as $list){ ?>
            <li>
                <div data-am-modal="{target: '#doc-modal-<?php echo $list["i"];?>-1', closeViaDimmer: 0, width: 400, height: 240}">
                    <img src="<?php echo $list["image"];?>" class="am-img-responsive" alt="<?php echo $list["title"];?>下载" />
                    <p class="schoolTitle"><?php echo $list["title"];?></p>
                    <p class="download">立即下载</p>
                </div>

                <div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-<?php echo $list["i"];?>-1">
                    <div class="am-modal-dialog">
...
<section class="writingInfoDownload am-padding-top-xl">
    <div class="am-container">
        <h2 class="title">
            <span class="num">03</span>
            <span class="numContent"><b class="en">MBA</b>联考<b class="red">笔试经验下载</b></span>
        </h2>
        <ul class="am-avg-sm-4 am-padding-top-sm am-padding-bottom-lg">
            ...
            <li>
                <div class="downloadBox" data-am-modal="{target: '#doc-modal-<?php echo $list["i"];?>-2', closeViaDimmer: 0, width: 400, height: 240}">
                    <img src="<?php echo $list["image"];?>" class="am-img-responsive" alt="<?php echo $list["title"];?>" />
                    <article class="rightBox">
                        <p class="schoolTitle"><?php echo $list["title"];?></p>
                        <p class="titleDescribe"><?php echo $list["description"];?></p>
                    </article>
                </div>
        ...
        <img src="/upload/2018-02-10/5.png" class="am-img-responsive am-center" alt="资料下载" />
    </div>
</section>
...
";s:12:"compile_time";i:1520318842;}";